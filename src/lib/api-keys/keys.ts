...
//
// Why the `chatchacha_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a Chat Chacha key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `chatchacha_test_` variant
...
export const API_KEY_PREFIX = 'chatchacha_live_';
